...
description:  
img: assets/img/research/rodrigo_drum_resize_comp.jpeg
timeline: 7
category: research
published: true
front-desc: Exploring audio representations for drum-to-synthesizer timbre remapping using a technical-practice methodology and an approach for timbre remapping with non-differentiable synths using a genetic algorithm and neural networks for low-latency inference.
---
