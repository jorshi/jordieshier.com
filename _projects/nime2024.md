...
importance: 3
category: research
front-desc: Mapping timbre variations from an acoustic percussion instrument to a synthesizer in real-time with a differentiable drum synthesizer and a learned neural network for real-time performance. 
---
